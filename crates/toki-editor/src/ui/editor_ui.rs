...
pub(crate) use editor_ui_map_editor::{
    add_auto_tile_to_map_tileset, add_layer_to_map, auto_tile_entry_usage_count,
    available_map_editor_auto_tile_sources, begin_map_editor_edit, begin_new_map_dialog,
    begin_resize_map_dialog, build_map_editor_brush_entries, cancel_map_editor_edit,
    ...
    has_unsaved_map_editor_draft, load_map_editor_brush_source,
    load_map_editor_brush_source_for_tilemap, load_map_editor_tileset_meta,
    map_editor_brush_entry_atlas_name, map_editor_selected_label, mark_map_editor_dirty,
    move_layer, pick_map_editor_tile, remove_auto_tile_from_map_tileset, remove_layer_from_map,
    rename_layer, rename_map_auto_tile_display_name, resize_map, resolve_map_editor_tileset_path,
    ...
    take_pending_map_editor_tilemap_sync, take_pending_map_editor_tileset_sync,
    toggle_layer_above_entities, toggle_layer_visibility, LoadedMapEditorBrushSource,
    MapEditorAutoTileSource, MapEditorBrushEntry, MapEditorBrushKind, MapEditorDraft,
    MapEditorHistory, MapEditorTileInfo, MapEditorTool, MapResizeSpec, NewMapRequest,
};
...
pub(crate) use editor_ui_sprite_editor::{
    ...
    GradientMode, GradientStyle, PixelColor, ProceduralBrushMode, ResizeAnchor, SelectionMask,
    SpriteAssetKind, SpriteCanvas, SpriteCanvasViewport, SpriteEditorState, SpriteEditorTool,
    SpriteSelection,
};
...
pub struct MapEditorState {
    ...
    pub empty_checkerboard_cache_key: Option<String>,
    pub empty_checkerboard_texture: Option<egui::TextureHandle>,
    pub selected_tile_info: Option<MapEditorTileInfo>,
    pub show_new_map_dialog: bool,
    pub show_resize_map_dialog: bool,
    pub selected_auto_tile_source: Option<String>,
    pub pending_auto_tile_removal_entry_id: Option<String>,
    pub new_map_name: String,
    pub new_map_width: u32,
    pub new_map_height: u32,
    pub new_map_tile_width: u32,
    pub new_map_tile_height: u32,
    pub resize_remove_north: u32,
    pub resize_remove_east: u32,
    pub resize_remove_south: u32,
    pub resize_remove_west: u32,
    pub resize_add_north: u32,
    pub resize_add_east: u32,
    pub resize_add_south: u32,
    pub resize_add_west: u32,
    pub resize_remove_all: u32,
    pub resize_add_all: u32,
    pub new_map_requested: Option<NewMapRequest>,
    pub save_requested: bool,
    pub history: MapEditorHistory,
    pub pending_tilemap_sync: Option<TileMap>,
    pub pending_tileset_sync: Option<toki_core::assets::tileset::TileSetMeta>,
...
impl Default for MapEditorState {
    fn default() -> Self {
        Self {
            ...
            empty_checkerboard_cache_key: None,
            empty_checkerboard_texture: None,
            selected_tile_info: None,
            show_new_map_dialog: false,
            show_resize_map_dialog: false,
            selected_auto_tile_source: None,
            ...
            resize_remove_north: 0,
            resize_remove_east: 0,
            resize_remove_south: 0,
            resize_remove_west: 0,
            resize_add_north: 0,
            resize_add_east: 0,
            resize_add_south: 0,
            resize_add_west: 0,
