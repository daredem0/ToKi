...
pub use types::{
    canonical_indexed_color, indexed_slot_for_authored_color, preview_indexed_color,
    nearest_palette_slot, DiscoveredSpriteAsset, PixelColor, ResizeAnchor, SpriteAssetKind,
    SpriteEditorTool,
};
