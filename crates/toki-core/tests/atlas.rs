...
fn atlas_image_size_with_scattered_tiles() {
    ...
    tiles.insert("tile1".to_string(), TileInfo {
        position: UVec2::new(0, 0),
        properties: TileProperties::default(),
    });
    tiles.insert("tile2".to_string(), TileInfo {
...
fn atlas_get_tile_rect_with_different_tile_sizes() {
    let mut tiles = HashMap::new();
    tiles.insert("big_tile".to_string(), TileInfo {
...
fn atlas_with_special_characters_in_tile_names() {
    let mut tiles = HashMap::new();
    tiles.insert("tile-with-dashes".to_string(), TileInfo {
        position: UVec2::new(0, 0),
        properties: TileProperties::default(),
    });
    tiles.insert("tile_with_underscores".to_string(), TileInfo {
        position: UVec2::new(1, 0),
        properties: TileProperties::default(),
    });
    tiles.insert("tile with spaces".to_string(), TileInfo {
        position: UVec2::new(0, 1),
        properties: TileProperties::default(),
    });
    tiles.insert("tile123".to_string(), TileInfo {
