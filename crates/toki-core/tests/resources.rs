...
use toki_core::resources::{ResourceManager, ResourceError};
use glam::UVec2;
...
fn test_resource_error_display() {
    let io_error = ResourceError::Io(std::io::Error::new(std::io::ErrorKind::NotFound, "File not found"));
    ...
    assert_eq!(format!("{}", validation_error), "Asset validation error: Test validation error");
}